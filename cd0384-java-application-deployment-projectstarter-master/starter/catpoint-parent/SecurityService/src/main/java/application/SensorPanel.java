...
import servicesecurity.SecurityService;
import servicesecurity.StyleService;
...
public class SensorPanel extends JPanel implements StatusListener{
    ...
    //I feel I need access to the setSensorActivity method to be able to visually change the state of sensors when the system is armed and thus sensors are deactivated.
    public void setSensorActivityPublic(Sensor sensor, Boolean isActive){
        setSensorActivity(sensor, isActive);
    }
    @Override
