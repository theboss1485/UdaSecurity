...
public class SecurityServiceTest {
    ...
    public void addAndRemoveStatusListener(){
        SensorPanel panel = new SensorPanel(service);
        service.addStatusListener(panel);
        assert service.getStatusListeners().contains(panel);
        service.removeStatusListener(panel);
        assert !service.getStatusListeners().contains(panel);
    }
}
